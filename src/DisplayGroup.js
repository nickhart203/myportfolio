  ...
  return (
    <div>
      <div className="pageContainer">
        ...
        />
        <ProjectImage image={displaygroup1} alt="Coachella Mobile" newclass="mobile-scale-img" />
        ...
        />
        <ProjectImage image={displaygroup2} alt="Coachella UI" newclass="mobile-scale-img" />
        <ProjectTextRightUp
