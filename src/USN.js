      ...
      <div className="pageContainer">
        ...
        >
          ...
          <ProjectResults
            ...
            timeline1=""
            header="The results"
            body="After launch, US Nursing informed us that nurse profile completion as well as assignment applications increased dramatically and the average number of expired documents went down. The nurses also had a greater comprehension of what was required of them before they could apply. Lastly, the brand update also increased the level of trust the nurses have in the brand."
            linkCallout=""
            href=""
            linkTitle=""
          />
